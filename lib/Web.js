...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "cout", "dt-decisions", "express", "glob-watcher", "http", "path", "serve-index", "socket.io", "./Config", "./MockEndpoint", "./ProxyEndpoint", "./PluginExpressSendScript", "./PluginExpressStatic"], factory);
    }
