...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "cout", "dt-decisions", "express", "http", "https", "path", "serve-index", "socket.io", "glob-watcher", "./MockApi", "./Config", "./PluginExpressStatic", "./PluginExpressSendScript"], factory);
    }
    ...
    class WebServer {
        constructor() {
            ...
            this.addWebSocket();
            this.mockEp = new MockApi_1.MockEndpointAPI(this.app);
        }
        addWebSocket() {
